...
3. **프로젝트 만들기** — 아이디어를 사용자 흐름·첫 버전·AI 시작문으로 변환
4. **GuideFlow에서 배운 기술** — 설치·개발 도구의 사용 이유와 실제 시행착오
...
- [PROJECT_RECIPES.md](PROJECT_RECIPES.md) — 영어 학습·영상 제작·업무 정리 프로젝트 시작 예시
...
- 네 가지 핵심 입구 중 하나를 선택해 바로 시작할 수 있습니다.
